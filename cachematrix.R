...
## function (makeCacheMatrix) calculates the inverse of matrix x, and stores it in the memory cache. The second call 
...
## are 3 sub-functions: get, getinverse, and setinverse which 1) retrieves input matrix x (get), 2) calculates and stores 
